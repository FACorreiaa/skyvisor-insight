...
func AirportTableComponent(airport models.AirportTable) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		for _, col := range airport.Column {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/view/airports/AirportTable.templ`, Line: 29, Col: 20}
			}
		...
		for _, airport := range airport.Airports {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/view/airports/AirportTable.templ`, Line: 51, Col: 30}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/view/airports/AirportTable.templ`, Line: 53, Col: 32}
			}
			...
			if airport.PhoneNumber.Valid {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/view/airports/AirportTable.templ`, Line: 55, Col: 59}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/view/airports/AirportTable.templ`, Line: 61, Col: 29}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/view/airports/AirportTable.templ`, Line: 62, Col: 24}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/view/airports/AirportTable.templ`, Line: 63, Col: 48}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/view/airports/AirportTable.templ`, Line: 64, Col: 49}
			}
