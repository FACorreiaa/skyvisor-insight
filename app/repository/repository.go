...
func NewAirlineRepository(db *pgxpool.Pool) *AirlineRepository {
	return &AirlineRepository{pgpool: db}
}
...
func (r *AirlineRepository) GetAirlinesExample(ctx context.Context, page,
	...
	return r.getAirline(ctx, query, name, orderBy, sortBy, offset, pageSize)
}

func (r *AirlineRepository) GetAirlineSumExample(ctx context.Context) (int, error) {
	var count int
...
func (r *AirlineRepository) GetAirlinesLocationsExample(ctx context.Context) ([]models.Airline, error) {
...
func (r *AirlineRepository) GetAirlineByNameExample(ctx context.Context, airlineName string) (models.Airline, error) {
	var al models.Airline
	query := `
