...
func detailedMapContainer(data models.LiveFlights) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_detailedMapContainer_429d`,
		Function: `function __templ_detailedMapContainer_429d(data){console.log('data', data)
    ...
    function addLater(features, timeout) {
		...
		Call:       templ.SafeScript(`__templ_detailedMapContainer_429d`, data),
		CallInline: templ.SafeScriptInline(`__templ_detailedMapContainer_429d`, data),
	}
}
