...
func CountryTable(c models.CountryTable) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = components.InputComponent("Search by Country name", "/locations/country").Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		for _, col := range c.Column {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `controller/html/locations/CountryTable.templ`, Line: 21, Col: 20}
			}
			...
			var templ_7745c5c3_Var3 templ.SafeURL = templ.URL(fmt.Sprintf("/locations/country?orderBy=%s&sortBy=%s", col.Title, col.SortParam))
		...
		for _, ct := range c.Country {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `controller/html/locations/CountryTable.templ`, Line: 43, Col: 25}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `controller/html/locations/CountryTable.templ`, Line: 45, Col: 23}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `controller/html/locations/CountryTable.templ`, Line: 46, Col: 25}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `controller/html/locations/CountryTable.templ`, Line: 47, Col: 28}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `controller/html/locations/CountryTable.templ`, Line: 48, Col: 45}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `controller/html/locations/CountryTable.templ`, Line: 50, Col: 28}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `controller/html/locations/CountryTable.templ`, Line: 51, Col: 27}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `controller/html/locations/CountryTable.templ`, Line: 52, Col: 43}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `controller/html/locations/CountryTable.templ`, Line: 53, Col: 44}
			}
		...
		templ_7745c5c3_Err = components.PaginatorComponent("/locations/country",
			...
			fmt.Sprintf("/locations/country?page=%d&search=%s", c.LastPage, c.SearchParam)).Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
