	...
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		for index, item := range sidebar {
			...
			if len(item.SubItems) == 0 {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/view/components/sidebar.templ`, Line: 38, Col: 23}
				}
				...
				for _, subItem := range item.SubItems {
					...
					var templ_7745c5c3_Var6 templ.SafeURL = templ.SafeURL(subItem.Path)
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/view/components/sidebar.templ`, Line: 54, Col: 28}
					}
