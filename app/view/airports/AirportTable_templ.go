...
func AirportTableComponent(airport models.AirportTable) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, col := range airport.Column {
			...
			templ_7745c5c3_Var4, templ_7745c5c3_Err = templ.JoinURLErrs(templ.URL(fmt.Sprintf("/airports?orderBy=%s&sortBy=%s", col.Title, col.SortParam)))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/view/airports/AirportTable.templ`, Line: 43, Col: 100}
			}
		...
		for _, airport := range airport.Airports {
			...
			templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinURLErrs(templ.SafeURL(fmt.Sprintf("/airports/details/%d", airport.AirportID)))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `app/view/airports/AirportTable.templ`, Line: 60, Col: 85}
			}
			...
			if airport.PhoneNumber.Valid {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 18, "<td>Phone not available</td>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
